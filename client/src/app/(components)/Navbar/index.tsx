        ...
        <div className='flex justify-between items-center w-full mb-7'>
            ...
            <div className='flex justify-center gap-5'>
                ...
                <div className='relative'>
                    <input type='search' placeholder='Start type to search groups & products' className='pl-10 pr-4 py-2 w-50 md:w-80 border-2 borde-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500' />
            ...
            <div className='flex justify-between itemc-center gap-5'>
